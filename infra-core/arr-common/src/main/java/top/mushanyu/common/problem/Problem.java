...
public interface Problem {
    ...
    static ProblemBuilder builder(Problem problem) {
        ProblemBuilder builder = builder().withTitle(problem.getTitle())
    ...
    static ThrowableProblem valueOf(final Response.StatusType status) {
        return GenericProblems.create(status).build();
    }

    static ThrowableProblem valueOf(final Response.StatusType status, final String detail) {
        return GenericProblems.create(status).withDetail(detail).build();
    }

    static ThrowableProblem valueOf(final Response.StatusType status, final URI instance) {
     ...
     * @see Problem#valueOf(Response.StatusType)
     * @see Problem#valueOf(Response.StatusType, String)
     * @see Problem#valueOf(Response.StatusType, URI)
     * @see Problem#valueOf(Response.StatusType, String, URI)
     */
