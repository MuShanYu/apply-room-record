...
public class MessageQuery {
    public SelectStatementProvider queryMessageListSql(String receiveUserId, MessageType messageType) {
        return select(MessageQueryRepository.selectList)
                ...
                .and(MessageDynamicSqlSupport.messageType, isEqualTo(messageType))
